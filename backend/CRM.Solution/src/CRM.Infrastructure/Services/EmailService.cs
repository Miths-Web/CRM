...
namespace CRM.Infrastructure.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task<EmailDto> SendEmailAsync(CreateEmailDto createDto)
        {
            ...
            // Body zyada badi nahi honi chahiye (10 MB = ~10 million chars)
            if (!string.IsNullOrEmpty(createDto.Body) && createDto.Body.Length > 1_000_000)
                throw new ArgumentException("Email body is too large (max 1 MB text).");
